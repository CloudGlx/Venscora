                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-md-4">
                                <select class="form-select border-0 py-3">
                                    ...
                                    <option value="1">Property Typ 1</option>
                ...
                <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                    <div class="testimonial-item bg-light rounded p-3">
                        <div class="bg-white border rounded p-4">
                            <p> A tech company reinventing the space</p>
                            <p> Venscora Realtors Ltd takes the lead in the industry, driven by the ingenuity of brilliant minds in engineering, design, and strategy. Our exclusive platform, Paragon, revolutionizes the way agents and clients navigate the complexities of real estate property transactions, setting new standards for efficiency and effectiveness.</p>
                           
                        </div>
                    </div>
                    <div class="testimonial-item bg-light rounded p-3">
                        <div class="bg-white border rounded p-4">
                            <p>A brokerage of unparalleled agents</p>
                            <p>At Venscora Realtors Ltd, we're a pioneering real estate enterprise that empowers our agents, enabling them to focus on providing expert client advice. Combining the solution-oriented approach of a startup with the elegance reminiscent of a luxury brand, 
                                Venscora ushers in the next era of real estate excellence</p>
